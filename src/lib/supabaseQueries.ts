...
export async function getSiteSettings(): Promise<SiteSettings | null> {
  ...
  if (error) {
    ...
    if (useSupabaseData) logError('Error fetching site settings:', error);
    return null;
  }
  return data;
}
...
export async function getHeroSection(): Promise<HeroSection | null> {
  ...
  const { data, error } = await supabase
    ...
    .single();
  if (error) {
    if (useSupabaseData) logError('Error fetching hero section:', error);
    return null;
  }
  return data;
}
...
export async function updateHeroSection(updates: Partial<HeroSection>): Promise<HeroSection | null> {
  ...
  if (error) {
    logError('Error updating hero section:', error);
    throw error;
  }
  return data;
}
...
export async function getHeroImages(): Promise<HeroImage[]> {
  ...
  if (error) {
    if (useSupabaseData) logError('Error fetching hero images:', error);
    return [];
  }
  return data || [];
}
...
export async function getAllHeroImages(): Promise<HeroImage[]> {
  ...
  if (error) {
    logError('Error fetching all hero images:', error);
    return [];
  }
  return data || [];
}
...
export async function createHeroImage(image: Omit<HeroImage, 'id' | 'created_at' | 'updated_at'>): Promise<HeroImage | null> {
  ...
  if (error) {
    logError('Error creating hero image:', error);
    throw error;
  }
  return data;
}
...
export async function updateHeroImage(id: string, updates: Partial<HeroImage>): Promise<HeroImage | null> {
  ...
  if (error) {
    logError('Error updating hero image:', error);
    throw error;
  }
  return data;
}
...
export async function getGalleryImages(category?: string): Promise<GalleryImage[]> {
  ...
  if (error) {
    if (useSupabaseData) logError('Error fetching gallery images:', error);
    return [];
  }
  return data || [];
}
...
export async function getAllGalleryImages(): Promise<GalleryImage[]> {
  ...
  if (error) {
    logError('Error fetching all gallery images:', error);
    return [];
  }
  return data || [];
}
...
export async function createGalleryImage(image: Omit<GalleryImage, 'id' | 'created_at' | 'updated_at'>): Promise<GalleryImage | null> {
  ...
  if (error) {
    logError('Error creating gallery image:', error);
    throw error;
  }
  return data;
}
...
export async function getAllTeamMembers(): Promise<TeamMember[]> {
  ...
  if (error) {
    logError('Error fetching all team members:', error);
    return [];
  }
  return data || [];
}
...
export async function updateTeamMember(id: string, updates: Partial<TeamMember>): Promise<TeamMember | null> {
  ...
  if (error) {
    logError('Error updating team member:', error);
    throw error;
  }
  return data;
}
...
export async function deleteTeamMember(id: string): Promise<void> {
  ...
  if (error) {
    logError('Error deleting team member:', error);
    throw error;
  }
}
...
export async function getAllServices(): Promise<Service[]> {
  ...
  if (error) {
    logError('Error fetching all services:', error);
    return [];
  }
  return data || [];
}
...
export async function getAllTestimonials(): Promise<Testimonial[]> {
  ...
  if (error) {
    logError('Error fetching all testimonials:', error);
    return [];
  }
  return data || [];
}
...
export async function getWhyChooseUs(): Promise<WhyChooseUs[]> {
  ...
  if (error) {
    logError('Error fetching why choose us:', error);
    return [];
  }
  return data || [];
}
...
export async function getAllWhyChooseUs(): Promise<WhyChooseUs[]> {
  ...
  if (error) {
    logError('Error fetching all why choose us:', error);
    return [];
  }
  return data || [];
}
...
export async function createWhyChooseUs(item: Omit<WhyChooseUs, 'id' | 'created_at' | 'updated_at'>): Promise<WhyChooseUs | null> {
  ...
  if (error) {
    logError('Error creating why choose us:', error);
    throw error;
  }
  return data;
}
...
export async function updateWhyChooseUs(id: string, updates: Partial<WhyChooseUs>): Promise<WhyChooseUs | null> {
  ...
  if (error) {
    logError('Error updating why choose us:', error);
    throw error;
  }
  return data;
}
...
export async function deleteWhyChooseUs(id: string): Promise<void> {
  ...
  if (error) {
    logError('Error deleting why choose us:', error);
    throw error;
  }
}
...
export async function getJobPositions(): Promise<JobPosition[]> {
  ...
  if (error) {
    logError('Error fetching job positions:', error);
    return [];
  }
  return data || [];
}
...
export async function getAllJobPositions(): Promise<JobPosition[]> {
  ...
  if (error) {
    logError('Error fetching all job positions:', error);
    return [];
  }
  return data || [];
}
...
export async function createJobPosition(position: Omit<JobPosition, 'id' | 'created_at' | 'updated_at'>): Promise<JobPosition | null> {
  ...
  if (error) {
    logError('Error creating job position:', error);
    throw error;
  }
  return data;
}
...
export async function updateJobPosition(id: string, updates: Partial<JobPosition>): Promise<JobPosition | null> {
  ...
  if (error) {
    logError('Error updating job position:', error);
    throw error;
  }
  return data;
}
...
export async function deleteJobPosition(id: string): Promise<void> {
  ...
  if (error) {
    logError('Error deleting job position:', error);
    throw error;
  }
}
